...
// function cardCreation(weatherMain, temp, temp_min, temp_max) {
//   const card = document.createElement("div");
//   card.classList.add("card");

//   const forecastForToday = document.createElement("h4");
//   forecastForToday.textContent = 'Forecast for today'; 

//   const textOutput = document.createElement("div");
//   textOutput.id = "textOutput";
//   textOutput.classList.add("output");

//   const cloudsIcon = document.createElement("img");
//   cloudsIcon.id = "imgCloud";
//   cloudsIcon.classList.add("is_notVisible "); 
//   cloudsIcon.src = cloudsUrl;
  
//   const sunIcon = document.createElement("img");
//   sunIcon.id = "imgSun";
//   sunIcon.classList.add("is_notVisible "); 
//   sunIcon.src = sunUrl;

//   const temperature = document.createElement("h4");
//   temperature.textContent = 'Temperature';

//   const textOutput2 = document.createElement("div");
//   textOutput2.id = "textOutput2";
//   textOutput2.classList.add("output");
//   textOutput2.textContent = temp;

//   const minimumTemp = document.createElement("h4");
//   minimumTemp.textContent = 'Minimum temp.';

//   const textOutput3 = document.createElement("div");
//   textOutput3.id = "textOutput3";
//   textOutput3.classList.add("output");
//   textOutput3.textContent = temp_min;

//   const maximumTemp = document.createElement("h4");
//   maximumTemp.textContent = 'Maximum temp.';

//   const textOutput4 = document.createElement("div");
//   textOutput4.id = "textOutput4";
//   textOutput4.classList.add("output");
//   textOutput4.textContent = temp_max;
  
//   //Logica per visualizzazione delle icone meteo
//   if(weatherMain === "Clouds") {
//     cloudsIcon.classList.add('is_visible');
//     sunIcon.classList.remove('is_visible');
//   }else{
//     sunIcon.classList.add('is_visible');
//     cloudsIcon.classList.remove('is_visible');
//   }

//   cloudsIcon.classList.add('is_notVisible');
//   sunIcon.classList.add('is_visible');
//   textOutput.append(cloudsIcon, sunIcon);
//   card.append(forecastForToday, textOutput, temperature, textOutput2, minimumTemp, textOutput3, maximumTemp, textOutput4);
...
//   filteredCities = ['Roma', 'Londra', 'Madrid', 'New York'];
